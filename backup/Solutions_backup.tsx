        ...
        <AnimatePresence mode="wait">
          ...
          >
            <div className="md:grid md:grid-cols-5">
              ...
              <div className="md:col-span-3 relative flex items-center justify-center p-8 md:p-4 overflow-hidden">
                ...
                <div className="relative z-10 w-full h-full flex items-center justify-center">
                  <div className="w-full h-full flex items-center justify-center">
                    ...
                    >
                      {activeTab === 0 && (
                        <div className="visualization-container w-full h-full flex items-center justify-center" style={{ minHeight: "450px" }}>
